...
from blog.models import BlogPage, Page #PersonPage, EventPage, Advert,
...
@register.inclusion_tag('blog/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag(
    'blog/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'blog/tags/person_listing_homepage.html',
    takes_context=True
)
